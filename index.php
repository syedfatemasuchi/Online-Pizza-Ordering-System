...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Pizza</span> Zone.</a>
      <nav class="navbar">
         <a href="#home">Home</a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>"Every bite of this pizza is made with love and topped with deliciousness. Enjoy each slice, knowing it was crafted with passion and care."</p>
      ...
      <div class="box">
         ...
         <p>"Our commitment to you: piping hot pizza, delivered to your door in 30 minutes or less. Because we believe that great taste should never be kept waiting."</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>"Sharing this incredible pizza with friends doubles the joy and multiplies the fun. Grab a slice, make memories, and savor the moments together!"</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <div class="price"><?= $fetch_products['price'] ?> TK</div>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="grand-total"> grand total : <span><?= $grand_total; ?> TK</span></div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box">
               ...
               <option value="paypal">Ucash</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>post code :</span>
            <input type="number" name="post_code" class="box" required placeholder="e.g. 1234" min="0" max="9999999" onkeypress="if(this.value.length == 4) return false;">
         </div>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            Online based you can order food as you wish. We have two method. You can pay through mobile banking or cash.
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            It depends on the distance from your location.We will deliver your food as soon as possible.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            Yes. We take order for different parties like birthday, anniversary, openings etc.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="credit">
      &copy; copyright @ 2023 by <span>"Compiler_Error"</span> | all rights reserved!
   </div>
